    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><strong>Fecha de creación:</strong> {{ $vino->created_at->format('d/m/Y H:i') }}</li>
                <li class="list-group-item"><strong>Última actualización:</strong> {{ $vino->updated_at->format('d/m/Y H:i') }}</li>
                <li class="list-group-item"><strong>Tipo:</strong> {{ $vino->tipo }}</li>
                <li class="list-group-item"><strong>Cosecha:</strong> {{ $vino->cosecha }}</li>
            </ul>
        </div>
